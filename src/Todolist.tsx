...
const filterHandler=(filter:FilterValuesType)=>{
    ...
    return <div>
        ...
        <div>
            <Button nickName={'all'} callback={()=>filterHandler('all')}/>
            <Button nickName={'active'} callback={()=>filterHandler('active')}/>
            <Button nickName={'completed'} callback={()=>filterHandler('completed')}/>
        </div>
        <p></p>
        {
